...
def best_hyperparameters(
    ...
    """
    Tune two hyperparameters for one or more models and return the best settings.
    ...
    defaults = {
        ...
        "max_features":          ["sqrt", "log2", None] + [i/10 for i in range(1,11)],
